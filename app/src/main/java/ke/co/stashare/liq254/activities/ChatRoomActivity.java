...
import ke.co.stashare.liq254.helper.Message;
import ke.co.stashare.liq254.helper.ThreadAdapter;
...
public class ChatRoomActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegistrationBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                if (intent.getAction().equals(Constants.REGISTRATION_TOKEN_SENT)) {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < thread.length(); i++) {
                                ...
                                try {
                                    qdate = sdf.parse(sentAt);
                                } catch (ParseException e) {
                                    Log.d(TAG, "Date parsing exception.", e);
                                }
                                String dateString = sdff.format(qdate);


                                Message messagObject = new Message(userId, message, dateString, name);
    ...
    //This method will clear token of a logged out user
    private void cleartoken() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.PUT, URLs.CLEAR_TOKEN + id,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        progressDialog.hide();
                        ...
                        try {
                            ...
                            if(message.equalsIgnoreCase(Constants.TOKEN_CLEARED))

                            {
                                ...
                                Toast.makeText(ChatRoomActivity.this, "failed to log out,try again", Toast.LENGTH_LONG).show();
                            }
